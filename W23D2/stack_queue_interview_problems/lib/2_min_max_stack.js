...
class MinMaxStack {
    ...
    push(val) {
        ...
        if (!this.top) {
            ...
            if (val < this.minNode.value) {
                newNode.prevMinOrMax = this.minNode;
                this.minNode = newNode;
            } else if (val > this.maxNode.value) {
                newNode.prevMinOrMax = this.maxNode;
                this.maxNode = newNode;
            }
        }
        return ++this.length;
    ...
    pop() {
        ...
        if (this.top === this.bottom) {
            ...
            this.minNode = null;
            this.maxNode = null;
        } else if (this.minNode.value === this.top.value) {
            this.minNode = this.top.prevMinOrMax;
        } else if (this.maxNode.value === this.top.value) {
            this.maxNode = this.top.prevMinOrMax;
        }
