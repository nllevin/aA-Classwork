...
//     if ( [coins, amount] in memo ) return memo[[coins, amount]];
...
//         const coin = coins[i];
//         const remainingCoins = coins.slice(0, i + 1);
//         let numCoins = 0;
//         if (coin > amount) {
//             numCoins = minChange(remainingCoins.slice(0, i), amount, memo);
//         } else {
//             numCoins = 1 + minChange(remainingCoins, amount - coin, memo);
//         }

//         if (numCoins && (numCoins < minNum || !minNum)) minNum = numCoins;
//     };
    
//     memo[[coins, amount]] = minNum;
//     return minNum;
// }
